...
style.trail  = {common.color "#002b36"}
style.accent = {common.color "#002b36"}

style.dim       = {common.color "#93a1a1"}
style.divider   = {common.color "#e0dbc8"}
style.selection = {common.color "#bfbbaa"}
style.highlight = {common.color "#e0dbc8"}

style.line_number    = {common.color "#93a1a1"}
style.line_number2   = {common.color "#002b36"}
style.line_highlight = {common.color "#e0dbc8"}

style.scrollbar  = {common.color "#bfbbaa"}
style.scrollbar2 = {common.color "#9d9988"}
style.scrollbar3 = {common.color "#e0dbc8"}
