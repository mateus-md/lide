...
keymap.add({
    ...
    ["ctrl+alt+o"] = "project-manager:open-project",
    ["ctrl+alt+s"] = "project-manager:switch-project",
    ["ctrl+alt+n"] = "project-manager:add-project",
    ["ctrl+alt+d"] = "project-manager:remove-project",
    ["ctrl+alt+r"] = "project-manager:rename-project",
})
