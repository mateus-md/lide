...
local function project_scan_thread()
    ...
    local function diff_files(a, b)
        ...
        for i, v in ipairs(a) do
            ...
            or b[i].modified ~= v.modified then return true end
        end
    end
    ...
    local function get_files(path, t)
        ...
        for _, file in ipairs(all) do
            ...
            if not common.match_pattern(file, config.ignore_files) then
                ...
                file = (path ~= "." and path .. PATHSEP or "") .. file
...
function core.load()
    ...
    stt_view = require('core.statusview')
    cmd_view = require('core.commandview')
    ...
    core.command_view = cmd_view()
    core.status_view = stt_view()
...
function core.open_doc(filename)
    ...
    if filename then
        ...
        for _, doc in ipairs(core.docs) do
            ...
            if doc.filename and abs_filename ==
            system.absolute_path(doc.filename) then
...
function core.step()
    ...
    for t, a, b, c, d in system.poll_event do
        ...
        elseif t == "textinput" and did_keymap then

            did_keymap = false
        else

            local _, res = core.try(core.on_event, t, a, b, c, d)
